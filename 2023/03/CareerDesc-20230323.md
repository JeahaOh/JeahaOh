...
- 하루 평균 2700건의 배송 추적 기능을 Spring Async와 MyBatis Execute type batch 기능으로 처리 소요 시간 약 50% 감소
...
저의 이런 적극적인 커뮤니케이션을 통해 개선된 이벤트/프로모션 기능으로 마케팅 직군의 동료들은 더 유연하게 이벤트를 기획, 진행하였고 디자인 팀과 개발팀의 공수를 줄여 효율적이고 민첩하게 프로모션을 진행할 수 있게 되었습니다. 저의 소통에 대한 가치관과 능력으로 오늘의 집에서 의미있는 새로운 문제에 도전하고 더 좋은 세상을 만드는데 기여하고 싶습니다.
